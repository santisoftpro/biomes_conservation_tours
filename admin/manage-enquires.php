...
{				?>		
						  <tr>
							...
							<td width="50"><?php echo htmlentities($result->Subject);?></a></td>
							<td width="100"><?php echo htmlentities($result->budget);?></a></td>
							<td width="100"><?php echo htmlentities($result->hearbout);?></a></td>
							<td width="100"><?php echo htmlentities($result->destination);?></a></td>
							<td width="200"><?php echo htmlentities($result->Description);?></td>
